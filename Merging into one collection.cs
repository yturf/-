...
namespace Merging_into_one_collection
{
    internal class Program
    {
        ...
        {
            string[] array1 = new string[] { "один", "один", "три", "два" };
            string[] array2 = new string[] { "три", "три", "четыре", "пять" };

            List<string> mergeList = new List<string>();

            AddUniqueValues(mergeList, array1);
            AddUniqueValues(mergeList, array2);
        ...
        public static void AddUniqueValues(List<string> mergeList, string[] array)
        {
